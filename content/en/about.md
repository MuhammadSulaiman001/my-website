...
intro: >-
  Hi! I'm Muhammad Sulaiman, **AI Engineering Lead** 🧑🏿‍💻 and **Project manager** 💻 with **9+ years** in IT industry, holding a master degree in **AI/NLP** 🤖. I started working as Android applications developer at 2018, then as Windows applications developer at 2019, then as a tech lead and a project manager at 2024, Currently, I am working as AI Engineering Lead at LikeCard. I combine software engineering with AI and project management skills to solve complex problems in IT industry.
...
passion_text: >-
  I'm passionate about applying **AI & project management standards and best practices** to develop great solutions 🔬. At <a href="https://www.likecard.com/" target="_blank" rel="noopener noreferrer"><strong>LikeCard</strong></a>, I analyze e-commerce BigData and develope AI models from scratch then deploy the models to production to enable AI services through API endpoints📱. Previously at <a href="https://equivator.com/" target="_blank" rel="noopener noreferrer"><strong>Equivator</strong></a>, I led many teams to develop and deploy **fintech applications (mobile and web)** 🕝. My focus remains on building **scalable, efficient applications** that push the boundaries of technology while meeting real-world needs.

mix: >-
  With experience in both **Machine learning development** 🧑‍💼 and **project management** 💻, I bring a **unique perspective** to technical challenges. I've led teams through every step, **from creating user stories to code implementation**, always focusing on **practical, efficient solutions** ⚡. My commitment to **continuous learning** drives me to bridge disciplines and deliver value to my company.
...
quickfacts:
  - icon: "briefcase"
    title: "Current Role"
    value: "🤖 AI Engineering Lead at <a href=\"https://www.likecard.com\" target=\"_blank\" rel=\"noopener noreferrer\"><strong>LikeCard</strong></a>"
  - icon: "graduation-cap"
    title: "Education"
