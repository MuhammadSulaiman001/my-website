...
positions:
  - company: "LikeCard"
    ...
    bullet_points:
      - "Performed EDA on large-scale SQL datasets and engineered production-grade features (Pandas, Polasr, PySpark & SageMaker)"
      - "Trained ML models (XGBoost, LightGBM, CatBoost, Scikit-learn) and deployed the models as HTTP endpoints (FastAPI)."
      - "Containerized applications using Docker and contributed to CI/CD workflows; implemented secure secrets handling."
      - "Improved prediction model accuracy by 8% through targeted feature engineering and iterative model fine-tuning."
      - "Improved prediction PR-AUC by 8% through advanced feature engineering."
      - "Led the development of a rule-based system enabling clients to dynamically define and manage business rules for fraud detection (KBS)."
  
  - company: "BuildMate"
    company_url: "https://buildmate.com"
    role: "Tech Lead"
    period: "July 2024 - Jan 2026 (Full-time)"
    industry: "Seamless Construction Procurement"
    location: "Remote"
    company_description: "An innovative platform that redefines construction procurement in Saudi Arabia"
    bullet_points:
      - "Lead cross-functional teams, assign tasks and ensure timely delivery of high-quality software solutions."
      - "Manage Tech tools and design 3rd party integrations (e.g. HubSpot CRM, SendGrid, etc.) to streamline operations."
  ...
  - company: "Equivator"
    ...
    period: "October 2024 - July 2025 (Full-time)"
